  ...
  return {
    ...
    createTrackDetail(img, title, artist, songUrl) {
      ...
      const html = `
            ...
            <button id="playButton" class="icon" onclick="playSong()"><i class="bi bi-play"></i></button> 
            <button id="playButton" class="icon" onclick="pauseSong()"><i class="bi bi-play"></i></button>
...
var song=document.getElementById("playButton");
function playSong()
{
